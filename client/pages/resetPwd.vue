    ...
    <div v-if="validJWT==true">
      <form method="post" @submit.prevent="updatePassword">
        ...
        <div class="mb-3 mt-3">
          ...
          <input v-bind:type="[showPassword ? 'text' : 'password']" class="form-control" id="password" data-toggle="password" placeholder="Enter password" name="password"
